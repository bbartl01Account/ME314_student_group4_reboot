...
class PegPlaceNode(Node):
    def __init__(self):
        ...
        # Min Z-force to consider that a collision occured
        self.minCollisionForce = 2 # Newtons
    ...
    def checkCollision(self):
        ...
        if baseForce[2] > self.minCollisionForce:
        ...
        if self.state == INITIALIZATION:
            if Event == ES_TIMEOUT:
                ...
                if self.haveDepthImage and self.haveIntrinsics_RBG and self.haveColorImage and self.haveWrench:
                    ...
                    self.get_logger().info(f'Camera and force stuff has been obtained . . . Sending Request to find peg')
            ...
            if Event == ES_TIMEOUT or Event == ES_COMMAND_EXECUTED:
                ...
                if result == ES_ITEM_UNDETECTED:
                    ...
                    # Have the gripper return to home pose, then move gripper over the peg
                    ...
                    wrapper_gripper_open.gripper_command.gripper_position = 0.25 # Change this to appropriate starting amount!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                    ...
                    wrapper_item.pose_command.z = self.ItemPoint[2] - 0.01 # May need to adjust!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                    ...
                    self.get_logger().info(f'Blue square found . . . Will grab the peg and return home')
